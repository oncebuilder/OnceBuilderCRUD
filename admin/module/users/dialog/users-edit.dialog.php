			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><i class="fa fa-files-o"></i> Edit user
						<button class="btn btn-default btn-sm pull-right item-uninstall" style="margin-right: 30px;" type="button"><i class="fa fa-trash-o"></i> Delete</button>
					</h4>
				</div>
							...
							<div class="tab-content">
								<div class="tab-pane active" id="edit_profile">
									<div class="row margin">
										<div class="col-md-12">
											<form id="editForm" action="ajax.php?c=users&o=item_edit&id=<?php echo $_GET['id'];?>" method="post">
												<div class="row">
													<div class="col-md-9">
														<div class="row">
															<div class="col-md-6">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input type="text" value="<?php echo $data['item']['password'];?>" class="form-control" name="password" placeholder="Enter password">
																</div>
															</div>
														</div>
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input type="text" value="<?php echo $data['item']['type_id'];?>" class="form-control" name="type_id" placeholder="Enter type">
																</div>
															</div>
														</div>
														<div class="row">
															...
															<div class="col-md-12">
																<div class="thumbnail">
																	<div class="caption">
																		...
																		<p>&nbsp;</p>
																		<p>
																			<a href="#" class="label label-default item-logo" title="Change logo">Change logo</a>
																		</p>
																	</div>
																	<img id="item-logo" src="/uploads/<?php echo $_GET['id'];?>/photo.png?<?php echo time();?>" onerror="this.src='img/emptylogo.png'">
																</div>
															</div>
														</div>
													</div>
